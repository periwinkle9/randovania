...
class Ui_HuntersGameExportDialog(object):
    def setupUi(self, HuntersGameExportDialog):
        ...
        self.gridLayout.addWidget(self.cancel_button, 7, 1, 1, 1)
        ...
        self.output_format_label = QLabel(HuntersGameExportDialog)
        self.output_format_label.setObjectName(u"output_format_label")

        self.gridLayout.addWidget(self.output_format_label, 5, 0, 1, 1)
    ...
    def retranslateUi(self, HuntersGameExportDialog):
        ...
        self.output_format_label.setText(QCoreApplication.translate("HuntersGameExportDialog", u"Output Format", None))
